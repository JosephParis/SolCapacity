...
class SolarDataset(torch.utils.data.Dataset):
    def __init__(self, root, transforms=None):
        ...
        self.imgs = sf.ign_img
        self.masks = sf.ign_mask

    def __getitem__(self, idx):
        # load images and masks
        img_path = os.path.join(self.root, "bdappv/ign/img", self.imgs[idx])
        mask_path = os.path.join(self.root, "bdappv/ign/mask", self.masks[idx])
